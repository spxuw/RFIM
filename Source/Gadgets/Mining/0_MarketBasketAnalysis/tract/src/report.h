...
extern void       isr_direct   (ISREPORT *rep, const ITEM *items,ITEM n,
                                RSUPP supp, double wgt, double eval);
extern void       isr_directx  (ISREPORT *rep, const ITEM *items,ITEM n,
                                const double *iwgts,
                                RSUPP supp, double wgt, double eval);
extern void       isr_rule     (ISREPORT *rep, const ITEM *items,ITEM n,
